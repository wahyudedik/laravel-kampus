...
@section('page-actions')
    <div class="btn-list">
        <a href="{{ route('mahasiswa.index') }}" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('bukti_pembayaran') is-invalid @enderror"
                                id="bukti_pembayaran" name="bukti_pembayaran" required data-bs-toggle="tooltip"
                                data-bs-placement="top"
                                title="Upload bukti pembayaran dalam format gambar (JPG, PNG) Maksimal 2MB">

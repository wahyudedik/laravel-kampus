...
@section('page-actions')
    <div class="btn-list">
        <a href="{{ route('pembayaran-mahasiswa.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
            <i class="ti ti-arrow-left"></i> Kembali
        </a>
        <a href="{{ route('pembayaran-mahasiswa.edit', $pembayaranMahasiswa->id) }}"
            class="btn btn-primary d-none d-sm-inline-block">
            <i class="ti ti-edit"></i> Edit Pembayaran
        </a>
    </div>
@endsection
@section('content')
        ...
        <div class="card-footer">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <form action="{{ route('pembayaran-mahasiswa.destroy', $pembayaranMahasiswa->id) }}" method="POST"
                        class="d-inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger delete-confirm"
                            data-name="{{ $pembayaranMahasiswa->nama_mahasiswa }}">
                            <i class="ti ti-trash"></i> Hapus Pembayaran
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div class="card mt-4">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <span class="badge bg-primary text-white">Total: {{ $pembayaranMahasiswaAll->count() }} Pembayaran</span>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">

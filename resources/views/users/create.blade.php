                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                ...
                                title="Masukkan password minimal 8 karakter">
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                                ...
                                placeholder="Masukkan konfirmasi password" required data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Masukkan ulang password yang sama">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('usertype') is-invalid @enderror" id="usertype"
                                ...
                                <option value="mahasiswa" {{ old('usertype') == 'mahasiswa' ? 'selected' : '' }}>Mahasiswa
                                </option>
